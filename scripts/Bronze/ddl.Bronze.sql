...
IF OBJECT_ID('bronze.crm_costore_info', 'U') IS NOT NULL
    DROP TABLE bronze.crm_costore_info;
GO

CREATE TABLE bronze.crm_costore_info (
    cst_id              INT,
    cst_key             NVARCHAR(50),
...
IF OBJECT_ID('bronze.erp_local_info', 'U') IS NOT NULL
    DROP TABLE bronze.erp_local_info;
GO
